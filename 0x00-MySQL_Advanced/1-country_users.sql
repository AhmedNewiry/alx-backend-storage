-- Task: Create a 'users' table with an auto-incrementing primary key, unique email, name field, and a country field with an enumeration.
...
CREATE TABLE IF NOT EXISTS users (
    ...
    country ENUM('US', 'CO', 'TN') NOT NULL DEFAULT 'US',  -- Country field with enumeration, default is 'US'
